...
wget https://unofficial-builds.nodejs.org/download/release/v17.0.0/node-v17.0.0-linux-x86.tar.gz
tar -xzf node-v17.0.0-linux-x86.tar.gz
cd node-v17.0.0-linux-x86
sudo cp -R * /usr/local/
sudo ldconfig
